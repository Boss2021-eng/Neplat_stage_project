...
import Card1 from '../assets/img/Card3/Card1.png';
...
import Slider from '../assets/img/Card3/Slider.png';
    ...
    <div className="w-full">
      <div className="w-full  flex flex-col items-center ">
        <div className="flex items-center justify-between bg-[#F4F6F8] w-full px-4 py-2 rounded-md mb-6">
          <p className="text-lg text-[#858A93]">To do</p>
        ...
        <div className="w-[90%] my-4">
          <img className="w-full" bg-blue-900 src={Card1} alt="Card1" />
        </div>
        <div className="w-[90%]">
          <div>
